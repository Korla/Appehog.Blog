...
image: "/src/assets/aoc.jpg"
---
import BlogImage from "../../components/blogImage.astro"
import aocImage from "../../assets/aoc.jpg";
...
<BlogImage
    src={aocImage}
    alt="Image of a birch tree taken form the kitchen"
    subtitle="So, how lazy was I? I took this photo from the warmth of the kitchen"
/>
